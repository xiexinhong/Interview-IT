package org.xxh.interview.utils.json;
...
public abstract class JsonValue implements Serializable {
    ...
    protected static JsonValue parseValue(String s) {
        ...
        if (curChar == '"') {
            ...
            // 去除数字中非法字符，数字有效字符为:数字、负号以及小数点、科学计数法E
            eIdx = --sIdx;
            do {
                curChar = s.charAt(eIdx);
            } while (((curChar > 47 && curChar < 58) || curChar == '-' || curChar == '.' || curChar == 'E' || curChar
                    == 'e') && ++eIdx < len);
            String str = s.substring(sIdx, eIdx);
